...
from .forms import AuthForm, RegisterForm, EditForm, RestorePasswordForm
...
def index(request):
    ...
    return render(request, 'app_users/index.html', context=context)
...
class EditProfileForm(View):
    ...
    def get(self, request, user_id):
        ...
        return render(request, 'app_users/edit_profile.html', {'form': edit_user_form})
