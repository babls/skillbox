...
from app_news.views import NewsFormCreate, NewsFormEdit, InfoNewsAndComment, CommentsFormCreate, NewsModeration
...
urlpatterns = [
    ...
    path('moderation_news/', NewsModeration.as_view(), name='moderationNews')
]
